...
public class RepositoryImpl<T extends Entity> implements Repository<T> {
    ...
    public void add(T entity) throws Exception {
        if (findById(entity.getId()).isPresent()) {
            throw new Exception("ID-ul trebuie să fie unic!");
        }
        entities.add(entity);
    }
    ...
    public void update(T entity) throws Exception {
        ...
        if (existingEntity.isEmpty()) {
            throw new Exception("Entitatea nu a fost găsită!");
        }
        delete(entity.getId());
        add(entity);
    }
    ...
    public void delete(int id) throws Exception {
        T entity = findById(id).orElseThrow(() -> new Exception("Entitatea nu a fost găsită!"));
